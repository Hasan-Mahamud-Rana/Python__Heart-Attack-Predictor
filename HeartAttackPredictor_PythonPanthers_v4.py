...
#              1. GaussianNB Classfication                                                  #
#              2. LogisticRegression Classfication                                          #
#              3. KNeighborsClassifier Classfication                                        #
#              4. SVC Classfication                                                         #
...
os.chdir("F:/Conestoga/Course/BigdataPgmmg/PROJECT")

Training_ML_File = pandas.read_csv("Train_The_ML_Model.csv")    # Load the Input CSV file to a data frame 
 
Patient_Record = pandas.read_csv("Patient_Health_Record.csv")   # Load the Testing Input CSV file to a data frame
...
List_Classification_DF2.to_excel('ClassificationData.xlsx', sheet_name="Model Comparison",index=True)
...
High_Risk = ['High risk of Heart Attack']
No_Risk = ['No risk of Heart Attack']
...
Heart_Condition_Predictor_DF.columns =['Age','Sex','Chest_Pain_Type','Resting_BP','Cholestrol','Fasting_Blood_Sugar','Resting ECG','Max_Heart_Rate','exercise_angina','ST_Segment_Depression','Heart_Rate_Slope','flourosopy_Vessels','thalassemia','Heart_Attack_Prediction']

# Generate Output CSV file with Prediction results
Heart_Condition_Predictor_DF.to_csv('Patient_Heart_Condition_Predictor.csv', index=False)
